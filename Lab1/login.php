<?php
    ...
    $users = array("tanvir"=>"1234","sabbir"=>"123");
	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
        ...
        if(!$hasError)
        {
            foreach($users == as $u=>$p)
            {
                if($uname == $u && $pass==$p)
                {
                    setcookie("loggeduser",$uname,time()+110);
        ...
        <legend>Admin Signup</legend>
			<table>
				...
				<tr>
					...
					<span style="color:black;"><?php echo $err_uname;?></span></td>
				</tr>

				<tr>
					<td align="right">Password</td>
					<td>:<input name="password" value="<?php echo $pass;?>" type="password"><br>
					<span style="color:black;"><?php echo $err_pass;?></span></td>
				</tr>
